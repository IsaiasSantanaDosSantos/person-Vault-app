...
- Ações manuais pendentes do painel do Supabase (MFA testado ponta a ponta, leaked password protection, rate limiting/CAPTCHA de login, troca de senha mestra) continuam exatamente como estavam — nada nesta sessão dependia delas nem as resolveu.
